...
public class Lista implements SuperCola{
	Integer[] contenedor;
	...
	/**
	 * El criterio de igualdad es que la longitud y los elementos del array sean iguales
	 */
	@Override
	public boolean equals(Object otro) {
		Lista otraLista = (Lista) otro;
		boolean iguales= Arrays.equals(this.contenedor,otraLista.contenedor);
		return iguales;
	}
